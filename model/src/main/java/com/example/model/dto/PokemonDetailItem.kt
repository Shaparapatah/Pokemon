...
/** Конвертер сначало преобразует данные в строку, затем использует эти приобразователи.
Они нужны для того, чтобы иметь возможность конвертировать данные в необходимые типы */
